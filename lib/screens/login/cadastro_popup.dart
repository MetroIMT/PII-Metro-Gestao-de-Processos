...
Future<void> showCadastroPopup(BuildContext context) {
...
class _CadastroContent extends StatefulWidget {
  final Color metroBlue;
  final Color metroLightBlue;

  const _CadastroContent({
  ...
  @override
  State<_CadastroContent> createState() => _CadastroContentState();
}

class _CadastroContentState extends State<_CadastroContent> {
  ...
  Widget build(BuildContext context) {
    // Tornar o conteúdo um pouco mais espaçado
    return Column(
      ...
      children: [
        ...
        // Formulário com campos retangulares e bordas arredondadas
        Form(
          key: _formKey,
          child: Column(
            children: [
              TextFormField(
                ...
                decoration: _fieldDecoration(
                  label: 'Nome',
                  prefix: Icon(Icons.person_outlined, color: Colors.grey[600]),
                ),
              ...
              TextFormField(
                ...
                decoration: _fieldDecoration(
                  label: 'Senha',
                  prefix: Icon(Icons.lock_outline, color: Colors.grey[600]),
                ).copyWith(
                ...
                child: Ink(
                  ...
                  child: Container(
                    ...
                    child: _submitting
                        ...
                        : Text('Cadastrar', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                  ),
                ),
              ),
            ),
