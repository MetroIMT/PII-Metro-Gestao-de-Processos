...
void main() {
  group('Feature: Autenticação de Usuários', () {
    testWidgets('Scenario: Login bem-sucedido com credenciais válidas', (
      tester,
    ) async {
    ...
    testWidgets('Scenario: Login falha com credenciais inválidas', (
      tester,
    ) async {
      tester.view.physicalSize = const Size(1080, 1920);
      tester.view.devicePixelRatio = 1.0;
    ...
    testWidgets('Scenario: Login falha com campos vazios', (tester) async {
      tester.view.physicalSize = const Size(1080, 1920);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
    ...
    testWidgets('Scenario: Login falha com email de domínio inválido', (
      tester,
    ) async {
      tester.view.physicalSize = const Size(1080, 1920);
      tester.view.devicePixelRatio = 1.0;
      ...
      await tester.enterText(find.byType(TextField).first, 'usuario@gmail.com');
      await tester.pump();
      ...
      expect(find.textContaining('@metrosp.com.br'), findsOneWidget);
    });

    testWidgets('Scenario: Alternar visibilidade da senha', (tester) async {
      tester.view.physicalSize = const Size(1080, 1920);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
